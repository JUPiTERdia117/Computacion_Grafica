//Practica#11 (Maquina de estados) Monroy Salazar
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Animacion maquina de estados Monroy Salazar", nullptr, nullptr);
